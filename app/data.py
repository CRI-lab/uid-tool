...
def create_data():
    ...
    if request.method == "POST":
        ...
        project1 = data_info["project1"] = request.form["project1"]
        project2 = data_info["project2"] = request.form["project2"]
        ...
        try:
            ...
            download_url = url_for("data.download_readme", uid=uid)
