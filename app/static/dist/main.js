    ...
    return (function () {
            ...
            var htmx = {
                ...
                config: {
                    ...
                    disableSelector: "[hx-disable], [record-hx-disable]",
            ...
            // resolve with both hx and record-hx prefixes
            function hasAttribute(elt, qualifiedName) {
                return elt.hasAttribute && (elt.hasAttribute(qualifiedName) ||
                    elt.hasAttribute("record-" + qualifiedName));
            }
            ...
            function getAttributeValue(elt, qualifiedName) {
                return getRawAttribute(elt, qualifiedName) || getRawAttribute(elt, "record-" + qualifiedName);
            }
            ...
            /**
             * getInternalData retrieves "private" record stored by htmx within an element
             * @param {HTMLElement} elt
             * @returns {*}
             */
            ...
            function handleOutOfBandSwaps(fragment, settleInfo) {
                forEach(findAll(fragment, '[hx-swap-oob], [record-hx-swap-oob]'), function (oobElement) {
            ...
            function handlePreservedElements(fragment) {
                forEach(findAll(fragment, '[hx-preserve], [record-hx-preserve]'), function (preservedElt) {
                ...
                if (!scrollHandler) {
                    ...
                    setInterval(function () {
                        if (windowIsScrolling) {
                            ...
                            forEach(getDocument().querySelectorAll("[hx-trigger='revealed'],[record-hx-trigger='revealed']"), function (elt) {
                                maybeReveal(elt);
                            })
                        }
                    }, 200);
            ...
            function maybeReveal(elt) {
                if (!hasAttribute(elt, 'record-hx-revealed') && isScrolledIntoView(elt)) {
                    elt.setAttribute('record-hx-revealed', 'true');
                    var nodeData = getInternalData(elt);
            ...
            function hasChanceOfBeingBoosted() {
                return document.querySelector("[hx-boost], [record-hx-boost]");
            }

            function findElementsToProcess(elt) {
                if (elt.querySelectorAll) {
                    var boostedElts = hasChanceOfBeingBoosted() ? ", a, form" : "";
                    var results = elt.querySelectorAll(VERB_SELECTOR + boostedElts + ", [hx-sse], [record-hx-sse], [hx-ws]," +
                        " [record-hx-ws], [hx-ext], [hx-record-ext]");
                    return results;
                } else {
                    return [];
                }
            ...
            function getHistoryElement() {
                var historyElt = getDocument().querySelector('[hx-history-elt],[record-hx-history-elt]');
            ...
            function loadHistoryFromServer(path) {
                ...
                request.onload = function () {
                    if (this.status >= 200 && this.status < 400) {
                        ...
                        // @ts-ignore
                        fragment = fragment.querySelector('[hx-history-elt],[record-hx-history-elt]') || fragment;
            ...
            function encodeParamsForBody(xhr, elt, filteredParameters) {
                ...
                if (encodedParameters != null) {
                    ...
                    if (getClosestAttributeValue(elt, "hx-encoding") === "multipart/form-record" ||
                        (matches(elt, "form") && getRawAttribute(elt, 'enctype') === "multipart/form-record")) {
            ...
            ready(function () {
                ...
                var restoredElts = getDocument().querySelectorAll(
                    "[hx-trigger='restored'],[record-hx-trigger='restored']"
                );
